...
/*
	...
	foreach($typeids as $typeid) 
	{
    		...
    		$MegacyteBuyPrice  = 443;
    		$MegacyteSellPrice = 521;
    		
    		$MexallonBuyPrice  = 655;
    		$MexallonSellPrice = 700;
    		
    		$NocxiumBuyPrice  = 155;
    		$NocxiumSellPrice = 255;
    		
    		$PyeriteBuyPrice  = 512;
    		$PyeriteSellPrice = 576;
    		
    		$TritaniumBuyPrice  = 125;
    		$TritaniumSellPrice = 144;
    		
    		$ZydrineBuyPrice  = 527;
    		$ZydrineSellPrice = 544;
